...
public class Programmer {
	...
	//1.필드 선언...
	public String name;//String은 API 라이브러리
	public MyDate birthday;//MyDate는 내가 만든 클래스(User Definition)
	public float salary;
	public int bonus;
	...
	//추가...생성자
	public Programmer() {	}//기본생성자... 필드 초기화 안한다
	...
	//추가...개발자의 연봉(월급 * 12 + bonus)을 리턴하는 기능을 정의
